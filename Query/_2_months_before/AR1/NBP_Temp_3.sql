--NBP - ST.06 v_trans VISA i MC z podziałem na Inne Kraje .sql
...
,CASE 
	...
	WHEN VT.country in ('QZ', 'QZZ', 'SZ') THEN 'D09' --- Kosowo i  Eswatini - brak na liście od nbp, wrzucone do extra not allocated - ale to nie jest ue - trzeba by skonsultować z nbp
	WHEN VT.country = 'PR' THEN 'US' 
	ELSE VT.country end as CountryCode, 
	count(*) as 'ilosc', 
	sum(convert(money,abs((tr_amount))))/100 as 'wartość transakcji',
	0 as 'ilosc_internet',
    0 as 'wartosc_internet',
	count(case when tr_cash_req > 0 then 1 END) as 'ilość transakcji CashBack',
	sum(convert(money,abs((tr_cash_req/100))))as 'Wartość wypłat CashBack'
,CASE 
	WHEN cc_name in (
	...
	'Slovenia', 'Sweden', 'Hungary', 'Italy', 'Norway', 'Liechtenstein', 'Iceland') THEN 'wyróżnione'
...
WHERE 
	VT.country <> 'PL' --Kraje poza polską
GROUP BY 
	cc_name, VT.country 
UNION ALL
--transakcje MC
...
,CASE
	...
	WHEN MC.country in ('QZ', 'QZZ', 'SZ') THEN 'Extra UE not allocated'  --- Kosowo i  Eswatini - brak na liście od nbp, wrzucone do extra not allocated - ale to nie jest ue - trzeba by skonsultować z nbp
...
-- przekształcenia kodow MC na standard VISA(NBP)
	...
	WHEN MC.country ='SWZ' THEN 'D09'    --- Eswatini - brak na liście od nbp, wrzucone do extra not allocated - ale to nie jest ue - trzeba by skonsultować z nbp
...
,CASE 
	...
	'LUX','LVA','DEU','MLT','PRT','ROM','SVK','SVN','SWE','HUN','ITA', 'ISL', 'LIE', 'NOR') THEN 'wyróżnione'
	ELSE 'reszta świata' END 'podział NBP'
FROM 
...
WHERE 
 MC.country <> 'POL'   --Kraje poza polską
GROUP BY 
	cc_name, MC.country
...
INSERT INTO #geo6 VALUES ('AO', 'Angola', 'Angola łącznie z Kabinda')
INSERT INTO #geo6 VALUES ('AQ', 'Antarctica', 'Antarktyda')
INSERT INTO #geo6 VALUES ('AR', 'Argentina', 'Argentyna')
INSERT INTO #geo6 VALUES ('AS', 'American Samoa', 'Samoa Amerykańskie')
...
INSERT INTO #geo6 VALUES ('AZ', 'Azerbaijan', 'Azerbejdżan')
INSERT INTO #geo6 VALUES ('BA', 'Bosnia and Herzegovina', 'Bośnia i Hercegowina')
...
INSERT INTO #geo6 VALUES ('BG', 'Bulgaria', 'Bułgaria')
...
INSERT INTO #geo6 VALUES ('BY', 'Belarus', 'Białoruś')
...
INSERT INTO #geo6 VALUES ('CF', 'Central African Republic (the)', 'Republika Środkowoafrykańska')
INSERT INTO #geo6 VALUES ('CG', 'Congo (the)', 'Kongo')
INSERT INTO #geo6 VALUES ('CH', 'Switzerland', 'Szwajcaria')
INSERT INTO #geo6 VALUES ('CI', 'Côte d' + char(39)+ 'Ivoire', 'Wybrzeże Kości Słoniowej')
...
INSERT INTO #geo6 VALUES ('CV', 'Cabo Verde', 'Wyspy Zielonego Przylądka')
INSERT INTO #geo6 VALUES ('CW', 'Curaçao', 'Curacao')
INSERT INTO #geo6 VALUES ('CX', 'Christmas Island', 'Wyspa Bożego Narodzenia')
INSERT INTO #geo6 VALUES ('CY', 'Cyprus', 'Cypr')
INSERT INTO #geo6 VALUES ('CZ', 'Czechia', 'Czechy')
INSERT INTO #geo6 VALUES ('DE', 'Germany', 'Niemcy')
INSERT INTO #geo6 VALUES ('DJ', 'Djibouti', 'Dżibuti')
...
INSERT INTO #geo6 VALUES ('FJ', 'Fiji', 'Republika Fidżi')
...
INSERT INTO #geo6 VALUES ('GS', 'South Georgia and the South Sandwich Islands', 'Georgia Południowa i Sandwich Południowy')
...
INSERT INTO #geo6 VALUES ('HU', 'Hungary', 'Węgry')
...
INSERT INTO #geo6 VALUES ('IT', 'Italy', 'Włochy')
...
INSERT INTO #geo6 VALUES ('KH', 'Cambodia', 'Kambodża (Kampucza)')
...
INSERT INTO #geo6 VALUES ('KP', 'Korea (the Democratic People' + char(39) + 's Republic of)', 'Koreańska Republika Ludowo-Demokratyczna (Korea Północna)')
INSERT INTO #geo6 VALUES ('KR', 'Korea (the Republic of)', 'Republika Korei (Korea Południowa)')
...
INSERT INTO #geo6 VALUES ('LV', 'Latvia', 'Łotwa')
INSERT INTO #geo6 VALUES ('LY', 'Libya', 'Libia')
INSERT INTO #geo6 VALUES ('MA', 'Morocco', 'Maroko')
INSERT INTO #geo6 VALUES ('MD', 'Moldova (the Republic of)', 'Mołdowa')
...
INSERT INTO #geo6 VALUES ('MP', 'Northern Mariana Islands (the)', 'Mariany Północne')
...
INSERT INTO #geo6 VALUES ('SH', 'Saint Helena, Ascension and Tristan da Cunha', 'Wyspa Świętej Heleny')
INSERT INTO #geo6 VALUES ('SI', 'Slovenia', 'Słowenia')
INSERT INTO #geo6 VALUES ('SJ', 'Svalbard and Jan Mayen', 'Svalbard i Jan Mayen')
INSERT INTO #geo6 VALUES ('SK', 'Slovakia', 'Słowacja')
...
INSERT INTO #geo6 VALUES ('SS', 'South Sudan', 'Sudan Południowy')
INSERT INTO #geo6 VALUES ('ST', 'Sao Tome and Principe', 'Wyspy Świętego Tomasza i Książęca')
...
INSERT INTO #geo6 VALUES ('TF', 'French Southern Territories (the)', 'Francuskie Terytoria Południowe')
INSERT INTO #geo6 VALUES ('TG', 'Togo', 'Togo')
INSERT INTO #geo6 VALUES ('TH', 'Thailand', 'Tajlandia')
INSERT INTO #geo6 VALUES ('TJ', 'Tajikistan', 'Tadżykistan')
...
INSERT INTO #geo6 VALUES ('US', 'United States of America (the)', 'Stany Zjednoczone Ameryki Północnej łącznie z Portoryko i Navassa')
...
INSERT INTO #geo6 VALUES ('YE', 'Yemen', 'Jemen łącznie z wyspami Perim, Kamaran, Socotra')
INSERT INTO #geo6 VALUES ('ZA', 'South Africa', 'Republika Południowej Afryki')
INSERT INTO #geo6 VALUES ('ZM', 'Zambia', 'Zambia')
INSERT INTO #geo6 VALUES ('ZW', 'Zimbabwe', 'Zimbabwe')
INSERT INTO #geo6 VALUES ('D09', 'Extra UE not allocated', 'Pozostałe kraje')
--select * from #geo6
